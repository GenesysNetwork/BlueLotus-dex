import { BIT_QUERY, INFO_CLIENT, INFO_CLIENT2, STABLESWAP_SUBGRAPH_CLIENT } from 'config/constants/endpoints'
...
export const infoClient2 = new GraphQLClient(INFO_CLIENT2)
