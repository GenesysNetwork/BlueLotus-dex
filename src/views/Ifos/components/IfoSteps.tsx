    ...
    <CardBody>
      ...
      <Box>
        <Text color="textSubtle" small>
          {t(
            'The maximum amount of GSYS user can commit to the Public Sale, is equal to the average GSYS balance in the IFO GSYS pool prior to the IFO. Stake more GSYS to increase the maximum GSYS you can commit to the sale. Missed this IFO? You can keep staking in the IFO GSYS Pool to join the next IFO sale.',
          )}
        </Text>
...
const Step2 = () => {
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t('When the IFO sales are live, you can “commit” your GSYS to buy the tokens being sold.')} <br />
      </Text>
    </CardBody>
  )
}
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent GSYS tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
